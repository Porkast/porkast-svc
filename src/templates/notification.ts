                                        ...
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td style="width:64px;">
                                                            <img height="auto" src="https://porkast.com/porkast-logo.png"
                                                                style="border:0;display:block;outline:none;text-decoration:none;width:100%;" width="80" />
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:40px;word-break:break-word;">
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:24px;font-weight:bold;line-height:1;text-align:center;color:#555;">
                                                {{ keyword }} has {{ updateCount }} new podcast update
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:left;color:#555;">
                                                ...
                                                Your subscription {{ keyword }} has new podcast update.<br></br>
                                                {{#titleList}}
                                                - {{.}}<br>
                                                {{/titleList}}
                                            </div>
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:20px;text-align:left;color:#525252;">
                                                Best regards,<br><br>Porkast Team<br><br>
                                                <a href="https://porkast.com/" style="color:#2F67F6">porkast.com</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                                    ...
                                                    <tr>
                                                        <td align="center" style="font-size:0px;padding:0;word-break:break-word;">
                                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;font-weight:300;line-height:1;text-align:center;color:#575757;">
                                                                Porkast | Discover, Subscribe, Share Your Personalized Podcast
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
...
export const AGGREGATED_NOTIFICATION_TEMPLATE = `<!doctype html>
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml"
    xmlns:o="urn:schemas-microsoft-com:office:office">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-bottom:25px;word-break:break-word;">
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:22px;font-weight:bold;line-height:28px;text-align:center;color:#333;">
                                                {{ headerTitle }}
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:0px 25px 15px 25px;word-break:break-word;">
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;line-height:22px;text-align:left;color:#555;">
                                                Hello {{ nickname }},<br><br>
                                                {{ headerSubtitle }}
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;padding-top:20px;padding-bottom:35px;word-break:break-word;">
                                            <a href="{{ link }}" target="_blank" style="text-decoration:none;">
                                                <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                    role="presentation" style="border-collapse:separate;line-height:100%;">
                                                    <tr>
                                                        <td align="center" bgcolor="#2F67F6" role="presentation"
                                                            style="border:none;border-radius:4px;color:#ffffff;cursor:auto;padding:12px 28px;" valign="middle">
                                                            <p style="background:#2F67F6;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                                {{ buttonText }}
                                                            </p>
                                                        </td>
                                                    </tr>
